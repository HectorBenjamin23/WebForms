...
namespace Data.Common
{
    ...
    public class BaseRepository<TKey, TEntity> where TEntity : IBaseEntity
    {
        #region Properties
        ...
        {
            this.Open();
            Guid? uid = Connection.Insert<Guid, T>(obj, Transaction);
            this.Close();
            return uid;
        }
        ...
        {
            this.Open();
            Guid? uid = await Connection.InsertAsync<Guid, T>(obj, Transaction);
            this.Close();
            return uid;
        }
